...
<html>
  <head>
    <title>Online Driving Licence Examination</title>
    ...
    ?>
     ...
     <table width="100%">
      ...
      <tr>
        ...
        <font face="Verdana">
          <div align="center">
            <h1 style="color:#15504E;">Welcome to Online Driving Licence Examination</h1>
              <span class="style5">
                <!--<img src="image/paathshala.jpg" width="129" height="100">-->
                <span class="style7"><img src="images/logo.jpg" width="300" height="150"></span>        </span>
...
<p align="left" class="style5">&nbsp;</p>
      <blockquote>
          <p align="left" class="style5"><span class="style7">Welcome to Online Driving Licence Examination This Site will provide the test <strong>(Multiple Choice Questions)</strong> for Driving Licence Examination. 
    ...
    <td valign="top"><form name="form1" method="post" action="">
      ...
      <div align="center">
        <img src="images/id.png" width="180" height="160">
