...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2020 at 09:07 AM
...
(68, 26, 'You can overtake a vehicle that is in the front ', 'Through the left side of the vehicle ahead', 'Through the right side of the vehicle ahead', 'If the road is wide enough', 'none', 0);
...
('snehal', 25, '0000-00-00', 5),
('snehal', 26, '0000-00-00', 0),
('snehal', 26, '0000-00-00', 0);
...
(17, 'snehal', 'snehal', 'snehal jagdhane', 'nanded', 'nanded', 2147483647, 'snehal@gmail.com');
...
--
ALTER TABLE `mst_question`
  MODIFY `que_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;
...
--
ALTER TABLE `mst_test`
  MODIFY `test_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
