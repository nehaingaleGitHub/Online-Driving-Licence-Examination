        ...
        <form name="form1" method="post" action="signupuser.php" onSubmit="return check();">
          ...
          <font face="Verdana">
            <tr>
              ...
              <td><input type="text" name="lid" pattern="[a-zA-Z _]{4,25}" style="height:35px;width:238px;font-size:13pt;font-face:Verdana;color:#06535A;border:2px solid #0BC1D2;" placeholder="Desired Username"></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td><input name="name" type="text" id="name" pattern="[a-zA-Z _]{4,25}" style="height:35px;width:238px;font-size:13pt;font-face:Verdana;color:#06535A;border:2px solid #0BC1D2;" placeholder="Desired Full Name"></td>
            </tr>
            <tr>
              <td><font face="Verdana">Address</td>
              <td><textarea name="address" id="address" pattern="[a-zA-Z _]{4,25}" style="height:35px;width:238px;font-size:13pt;font-face:Verdana;color:#06535A;border:2px solid #0BC1D2;" placeholder="Address Details"></textarea></td>
            </tr>
            <tr>
              <td><font face="Verdana">City</td>
              <td><input name="city" type="text" id="city" pattern="[a-zA-Z _]{4,25}" style="height:35px;width:238px;font-size:13pt;font-face:Verdana;color:#06535A;border:2px solid #0BC1D2;" placeholder="City Name"></td>
            </tr>
            <tr>
              <td><font face="Verdana">Mobile</td>
              <td><input name="phone" type="text" id="phone" pattern="[0-9]{10}" style="height:35px;width:238px;font-size:13pt;font-face:Verdana;color:#06535A;border:2px solid #0BC1D2;" placeholder="Mobile Number"></td>
            </tr>
            <tr>
